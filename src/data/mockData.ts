...
import { Procedure, User, CategoryInfo, OnboardingSlide, Category } from '../types';

export const CATEGORIES: CategoryInfo[] = [
  { id: 'face', name: 'Face', icon: 'person-outline', color: '#F2A679' },
  { id: 'skin', name: 'Skin', icon: 'sparkles', color: '#D4A5D9' },
  { id: 'body', name: 'Body', icon: 'heart-outline', color: '#81B4D8' },
  { id: 'hair', name: 'Hair', icon: 'cut-outline', color: '#A5C9A5' },
  { id: 'makeup', name: 'Makeup', icon: 'color-palette-outline', color: '#E57B9D' },
  { id: 'brows', name: 'Brows', icon: 'eye-outline', color: '#C9A57B' },
  { id: 'lashes', name: 'Lashes', icon: 'eye', color: '#7B9DC9' },
  { id: 'nails', name: 'Nails', icon: 'hand-left-outline', color: '#FFB5B5' },
  { id: 'tan', name: 'Tan', icon: 'sunny-outline', color: '#F5C77B' },
];
...
export const ONBOARDING_SLIDES: OnboardingSlide[] = [
  {
    ...
    description: 'Log all your cosmetic procedures in one beautiful place. Never forget when you got your last treatment.',
    image: 'beauty',
  },
  {
    id: '2',
    title: 'Visualize Your Progress',
    description: 'Upload before & after photos and watch your transformation over time with our stunning comparison tools.',
    image: 'photos',
  },
  {
    id: '3',
    title: 'Never Miss a Touch-Up',
    description: 'Set smart reminders for maintenance appointments and keep your results looking fresh.',
    image: 'reminder',
  },
];
